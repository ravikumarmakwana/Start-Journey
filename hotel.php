            ...
            <div class="sidebar-wrap ftco-animate">
              ...
              <form action="" method="post">
                <div class="fields">
                  ...
                  <div class="form-group">
                    <input type="date" class="form-control" placeholder="Date from" name="">
                  </div>
                  <div class="form-group">
			  ...
			  <div class="row">
            	  <?php
                	if(isset($_POST['placeInfo']))
                	{
                  		$city=$_POST['city'];
                  		$place=$_POST['place'];
 	 	                $res=mysqli_query($conn,"select * from hotels where city like '%".$city."%' and title like '%".$place."%'");
            	    }
        	        else
               	 ...
               	 <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                      ...
                      <div class="text p-3">
                          <div class="d-flex">
                              ...
                              <div class="two">
									<span class="price per-price"><?php echo $price; ?><br><small>/night</small></span>
								</div>
                          </div>
