        ...
        <div class="row block-9">
          <div class="col-md-6 order-md-last pr-md-5">
            <form action="signup.php" method="post">
              ...
              <div class="form-group">
                <input type="number" name="phoneno" class="form-control" placeholder="Your Phone No.">
              </div>
              <div class="form-group">
                <textarea name="address" cols="30" rows="7" class="form-control" placeholder="Your address"></textarea>
              </div>
              <div class="form-group">
