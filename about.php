  ...
  <body>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('images/bg_1.jpg');">
      ...
      <div class="container">
        ...
        <div>
  				<p align="justify">Start Journey is Smart Travel Web Application that contain every things that need as tourusts that can search for visit a new place. It include details about all places in citywise, we can search as per our knowledge by place info or by name of places. It also include near by hotels, we search by with help of our budget. The amazing feature is chat bot, we can simply ask a questions and deal with chat bot and get live response.</p>
  			</div>
    	</div>
    </section>
