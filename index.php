    		...
    		<div class="row">
    			<div class="col-md-4">
    				<div class="intro ftco-animate">
    					...
    					<p>An Eassy way to enter the starting to ending places and get best way to travel.</p>
    				</div>
    			</div>
    			<div class="col-md-4">
    				<div class="intro ftco-animate">
    					<h3><span>02</span> Experience</h3>
    					<p>Best way to find Shortest path between your places</p>
    				</div>
    			</div>
    			<div class="col-md-4">
    				<div class="intro ftco-animate">
    					<h3><span>03</span> Relax</h3>
    					<p>Simply ask anything to chatbot and get live response.</p>
    				</div>
    			</div>
    		</div>
    	</div>
          ...
          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body">
                ...
                <p>Find best deals for flight tickets, hotels, Holiday Packages, Bus and train Reservations.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body">
                ...
                <p>Live Updates and Quick Response with Chatbot.</p>
              </div>
            </div>    
          </div>
          <div class="col-md-4 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body">
                ...
                <p>Ask Question like 'How to rich my place to chat-bot ?'</p>
              </div>
            </div>      
          </div>
        </div>
